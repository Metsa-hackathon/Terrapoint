...
- F2. Otsusepõhise vaate valimine
  - **Trigger:** A1 või A2 soovib uurida üldpilti, piiranguid või riske.
  - **Actors:** A1, A2
  - **Steps:** Kasutaja valib ühe kolmest olemasolevast vaatest; kaart aktiveerib selle küsimuse jaoks määratud teemad; legendirea avamine tõstab valitud teema esile ja tuhmib muud kihid; „Kõik nähtavad” taastab vaate täieliku kihikomplekti.
  - **Outcome:** Kaardil on vaikimisi näha otsuse jaoks vajalik tervik ning kasutaja saab ühe teema ruumilist ulatust eraldi uurida.
...
|---|---|
| Vaade | Nimega teemakomplekt. Olemasolevad vaated on „Ülevaade”, „Piirangud” ja „Riskid”. |
| Teema | Tähenduslik kaardiülekate, näiteks „Vesi ja kaldapiirangud”. „Piirangute” ja „Riskide” aktiivsed teemad saavad alati legendirea; „Ülevaates” saab eraldi teemarea kinnitatud kattuvus, teised kontrollid püsivad koondreas. Teemarea avamine fokusseerib teema kaardil. |
...
| Teemafookus | Ajutine kaardiolek, kus üks teema joonistatakse tugevamalt ja teised aktiivsed teemad ning metsaeraldised tuhmimalt. „Kõik nähtavad” eemaldab fookuse. |
...
- R4. Kaart peab säilitama kolm olemasolevat vaadet alloleva teemakomplektiga.

| Kaardielement | Ülevaade | Piirangud | Riskid |
|---|---|---|---|
| Kinnistu piir (püsikontekst) | Alati | Alati | Alati |
| Metsaeraldised (püsikontekst) | Alati | Alati | Alati |
| Looduskaitse | Olulisel kattuvusel | Sees | Väljas |
| Liigid ja elupaigad | Olulisel kattuvusel | Sees | Väljas |
| Vesi ja kaldapiirangud | Olulisel kattuvusel | Sees | Väljas |
| Muinsuskaitse ja muud tegevuspiirangud | Olulisel kattuvusel | Sees | Väljas |
| Üleujutus ja märgalad | Väljas | Sees | Sees |
| Metsatervise riskid | Väljas | Väljas | Sees |
| Võõrliigid | Väljas | Väljas | Sees |
...
- R5. Vaate valimine taastab selle tabelis määratud teemakomplekti ja eemaldab varasema teemafookuse. Teemarea avamine fokusseerib selle teema: fookuses teema joonistatakse pealmiseks ja tugevamalt, muud aktiivsed teemad ning metsaeraldised tuhmuvad, kuid jäävad ruumilise orientiirina nähtavaks. „Kõik nähtavad” sulgeb fokusseeritud detailirea ja taastab vaate täieliku nähtavuse ühe toiminguga.
- R6. Kasutaja fokusseerib teemasid, mitte üksikuid tehnilisi allikaid. Järved, vooluveed ning vee- ja kaldakaitse asjaolud kuuluvad teemasse „Vesi ja kaldapiirangud”; sama kaitseala dubleerivad kirjed võib koondada, kuid eri tähendusega piiranguid ei tohi üksnes ruumilise kattuvuse tõttu üheks muuta.

**Legend ja tähendus**

- R7. Kaardil peab olema üks ühine legend eraldi kinnistu piiri, metsaeraldiste ja aktiivsete teemade ridadega. Iga teemarida näitab vähemalt kaardisümbolit, inimkeelset nimetust, tulemi olekut ja tõlgenduspiiri; avatav detail näitab kõiki teema ametlikke allikaid, nende andmete ajaseisu või viimase kontrolli aega ning kattuvuse ulatust valitud kinnistu või eraldistega. Iga allika sümbol peab kasutama sama geomeetriatüüpi, värvi, täidet ja jooneviisi nagu selle allika objekt kaardil. Kokkuvajutatud teemarida näitab ruumi säästmiseks kuni kaht täpset allikasümbolit ja ülejäänute arvu; avatud detail seob kõik eristuvad sümbolid nende allikatega. Teema vasted ja olek käivad valitud kinnistu, mitte parajasti nähtava kaardiakna kohta; kaardi nihutamine ei laienda analüüsi ruumilist ulatust.
- R8. Aktiivne teema peab legendis säilima ka vaste puudumise või allikaprobleemi korral. Erand on „Ülevaate” veel kinnitamata kontroll: selle nulltulemus või tõrge jääb R4 koondrea detaili ja eraldi teemarida tekib ainult kinnitatud kattuvusele. Tulemi olek määratakse kogu teema allikate põhjal ja võib koos nähtavate vastetega näidata puudulikku katvust:
...
- R10. Metsateatis tuleb tulemuste lehel kirjeldada ametliku staatusega sündmusena, mitte tehtud raiet tõendava sündmusena; ainult lubava ja kehtiva staatusega teatist võib nimetada lubatud tööks ning muud staatused tuleb esitada nende ametliku tähenduse järgi. Teatis seotakse võimaluse korral eraldisega ja sündmused järjestatakse ametliku kuupäeva järgi; teadmata kuupäev või staatus jääb nähtavalt määramata. Kinnistuga seotud, kuid usaldusväärse geomeetria või eraldiseseoseta teatis kuvatakse „Asukoht kinnistul määramata” loendis, mitte oletusliku kaardisümbolina. Lageraietuvastus 2011–2016 peab näitama vaatlusperioodi ja arhiivilisust ning jääma teatisest eraldi sündmuseliigiks.
...
- R12. Vaikekaardi kasutatavus ei tohi sõltuda kõigi valikuliste teemade edukast laadimisest. „Ülevaate” olulise kattuvuse kontrollid käivitatakse enne vaste leidmist ja kuvatakse selle ajani koondreas; muude vaadete teemad laaditakse alles vastava vaate aktiveerimisel. Teema laadimisel on nähtav laadimisolek ja tõrke järel korduskatse. Kinnistu või vaate vahetamisel eemaldatakse aegunud kinnistupõhine sisu kohe ning hilinenud vastus ei tohi muuta enam aktiivse kinnistu või teema olekut.
...
- R14. Vaated, teemafookus ja ühine legend peavad jagama üht arusaadavat olekut. Enne kinnistu valimist on kasutatavad aluskaart ja senine kinnistuotsing, kuid kinnistupõhised vaated on selgitusega passiivsed. Uue kinnistu valimine taastab „Ülevaate” teemad ilma fookuseta, säilitades sama lehesessiooni jooksul valitud aluskaardi; lehe uuesti laadimine taastab ametliku ortofoto ja „Ülevaate”.
...
- AE2. **Covers R4, R5, R14.** Kui kasutaja valib „Riskid” ja avab „Võõrliigid”, joonistatakse võõrliikide objektid pealmiseks ja tugevamalt ning muud riskikihid tuhmuvad. „Kõik nähtavad” sulgeb detailirea ja taastab kõik „Riskide” kihid; „Ülevaate” valimine ei muuda kasutaja aluskaarti.
- AE3. **Covers R3, R6, R7.** Kui sama kaitseala saabub kahest ametlikust teenusest, näeb kasutaja üht „Looduskaitse” teemat ja selle detailis mõlemat allikat nende tegelike kaardisümbolitega. Kui samal alal kehtib eri tähendusega veekaitsepiirang, jääb see oma veeteemasse.
...
- AE13. **Covers R10.** Kui metsateatis kuulub kinnistule, kuid selle usaldusväärne geomeetria või eraldiseseos puudub, loendab tulemuste lehe metsateatiste osa selle vastena ja näitab „Asukoht kinnistul määramata”, kuid ei lisa kaardile oletuslikku sümbolit ega muuda metsateatiste järjekorda.
- AE14. **Covers R4, R5, R8, R12.** Kui „Ülevaate” kontroll leiab looduskaitse kattuvuse, veeteema vastab täieliku nulliga ja muinsuskaitse allikas ei vasta, näitab kaart looduskaitse ülekatet ning koondrida „Piirangute kontroll osaline”. Muinsuskaitse tõrge on detailis uuesti proovitav; looduskaitse fokusseerimisel jääb koondrida nähtavaks ning „Kõik nähtavad” taastab kõik ülevaatekihid.
- AE15. **Covers R11, R16.** Kui toetuse signaal kehtib terve kinnistu kohta ilma täpse geomeetriata ja teine signaal on tuletatud ühe eraldise tunnustest, näitab tulemuste lehe toetuste osa esimest „Kinnistu tasemel” ning teist vastava eraldise juures „Terrapointi tuletisena”. Tulemus ei kinnita toetuskõlblikkust ega lisa teadmata asukohale oletuslikku kaardisümbolit.
...
- Kasutaja saab ühe valikuga liikuda „Ülevaate”, „Piirangute” ja „Riskide” vahel, fokusseerida ühe teema ning taastada ühe toiminguga kõik vaate kihid.
...
- Esimesse versiooni ei kuulu vaadete teemakomplekti käsitsi muutmine ega kohandatud vaated.
...
- Teemafookus uute kihtide lülitite asemel: vaikimisi säilib kogu vaate kontekst, kuid legendirea avamine teeb ühe teema ruumilise ulatuse loetavaks.
